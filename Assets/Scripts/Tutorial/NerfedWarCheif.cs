...
[RequireComponent(typeof(NerfedNavPoller))]
...
public class NerfedWarCheif : MonoBehaviour
{
    [Header("Attack")]
    ...
    void Awake()
    {
        ...
        _navPoller = GetComponent<NerfedNavPoller>();
    ...
    {
        Debug.Log("InitFromPool called for WarChief");
        ...
        if (_releaseToPoolAction == null)
        {
            _releaseToPoolAction = releaseAction;
            Debug.Log("Assigned _releaseToPoolAction in InitFromPool for WarChief.");
        }
        else
        {
            Debug.Log("Already initialized _releaseToPoolAction for WarChief.");
        }
    }
